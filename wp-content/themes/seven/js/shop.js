var singleShop = new Vue({
    ...
    methods:{
        ...
        lottery:function(){
            ...
            this.rand(1);
            var that = this;
            axios.post(zrz_script.ajax_url+'zrz_shop_lottery','pid='+zrz_single.post_id+'&nonce='+zrz_script.nonce).then(function(resout){
...
var cart = new Vue({
    ...
    mounted:function(){
        ...
        axios.post(zrz_script.ajax_url+'zrz_shop_confirm',Qs.stringify(data)+'&nonce='+zrz_script.nonce).then(function(resout){
            if(resout.data.status == 200){
    ...
    methods:{
        ...
        setDefault:function(key){
            var that = this;
            axios.post(zrz_script.ajax_url+'zrz_set_default_address','key='+key+'&nonce='+zrz_script.nonce).then(function(resout){
                if(resout.data.status == 200){
                    that.defaultAddress = key;
                }
            })
